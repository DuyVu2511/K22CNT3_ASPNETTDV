...
namespace TDV.Lab04._2.Controllers
{
    public class TDVCustomerController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create(TDVCustomer cus)
        {
        ...
        // POST: /Customer/Edit
        [HttpPost]
        public ActionResult Edit(TDVCustomer cus)
        {
